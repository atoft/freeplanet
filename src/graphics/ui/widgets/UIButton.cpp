...
void UIButton::Draw(TimeMS _delta, UIDrawInterface& _display, bool _isFocused, bool _isActive)
{
    ...
    _display.DrawRectangle(m_Position, m_Dimensions, (_isFocused || _isActive) ? activeColor : inactiveColor);
